...
<div class="form-box">
    ...
    <form action="../backend/forgetemail.php" method="POST">
        ...
        <input type="text" name="email" id="email" placeholder="registered email" />
        <button type="submit">Send OTP</button>
    </form>
    <div class="alternative">
        <a href="./forgetpasswordphone.php">Verify with phone number instead</a>
    </div>
</div>
