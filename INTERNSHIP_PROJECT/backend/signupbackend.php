<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if(isset($_POST["firstname"]) && isset($_POST["middlename"]) && isset($_POST["lastname"]) && isset($_POST["email"]) && isset($_POST["phone"]) && isset($_POST["age"]) && isset($_POST["dob"]) && isset($_POST["password"]) && isset($_POST["confirmpassword"])) {
            ...
            $sql = "INSERT INTO INTERN_INFO (FIRSTNAME,MIDDLENAME,LASTNAME,EMAIL,PHONE,AGE,DOB,PASSWORD) VALUES ('$firstname','$middlename','$lastname','$email','$phone','$age','$dob','$password');";
