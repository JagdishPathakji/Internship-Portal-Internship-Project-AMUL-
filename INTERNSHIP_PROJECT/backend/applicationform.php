...
<?php
    ...
    if(isset($_POST["submit"])) {
        ...
        if($file1 && $file2) {
            ...
            $sql = "INSERT INTO APPLIERS (FIRSTNAME,MIDDLENAME,LASTNAME,AGE,PHONE,EMAIL,GRADYEAR,UNIVERSITY,EXPEREINCE,DESCRIPTION,RESUME_PATH,COLLEGE_LETTER_PATH,STATUS,JOBTITLE,GENDER,CITY,STATE) VALUES ('$firstname','$middlename','$lastname','$age','$phone','$email','$gradyear','$university','$exp','$description','$resumePath','$collegePath','UNDER CONSIDERATION','$jobtitle','$gender','$city','$state');";
